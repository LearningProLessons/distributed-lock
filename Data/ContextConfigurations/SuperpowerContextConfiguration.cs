...
namespace distributed_cache.Data.ContextConfigurations;
...
public class SuperpowerContextConfiguration : IEntityTypeConfiguration<Superpower>
{
    ...
    public void Configure(EntityTypeBuilder<Superpower> builder)
    {
        builder.HasData(
            ...
            new Superpower
            {
                Id = Guid.Parse("cccccccc-0000-0000-0000-000000000005"),
            ...
            new Superpower
            {
                Id = Guid.Parse("cccccccc-0000-0000-0000-000000000006"),
            ...
            new Superpower
            {
                Id = Guid.Parse("cccccccc-0000-0000-0000-000000000007"),
